...
/**
 * my_partition - Function that sets the pivot for quick_sort
 *
 * @array: Array to partition
 * @size: Size of array
 * Return: (i + 1)
 */
size_t my_partition(int array[], size_t size)
{
	int pivot;
	size_t i = -1;
	size_t j;
